	...
	foreach ($keys_of_division_unique as $item) {
       ...
       // echo("the destination zip will be " . $destination_zip);
        ...
        foreach ($var_division[$item] as $list_entries) {
            ...
            $original_location_file = str_replace('%3F', 'qm', $original_location_file);
            ...
            if ($array_source_location[0] != "")
            {
                ...
                $new_location_file = str_replace('%3F', 'qm', $new_location_file);
                ...
                $array_source_location[0] = str_replace('%3F', 'qm', $array_source_location[0]);
