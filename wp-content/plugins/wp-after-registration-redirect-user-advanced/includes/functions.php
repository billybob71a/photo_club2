<?php
	...
	if ( isset( $_POST['wparua_registration_redirect_filter_reset'] ) ) {
			...
			if ( ! isset( $_POST['wparua_after_registration_redirect_filters_submit'] )
		    	|| ! wp_verify_nonce( $_POST['wparua_after_registration_redirect_filters_submit'], 'wparua_after_registration_redirect_filters_submit' )
			) {
