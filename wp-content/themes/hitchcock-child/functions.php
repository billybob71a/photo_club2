...
if ( wp_is_mobile() ) { function add_petery_script() {
    wp_register_script('petery_script_mobile', get_template_directory_uri() . '-child/js/petery_script_mobile.js', array( 'jquery' ),'1.1',true);
    wp_enqueue_script('petery_script_mobile');
}
}
else { function add_petery_script() {
    wp_register_script('petery_script', get_template_directory_uri() . '-child/js/petery_script.js', array( 'jquery' ),'1.2',true);
